...
const INVOICE_JSON_PROMPT = `Tu analyses un justificatif d'achat français : facture, ticket de caisse ou ticket carburant (station-service).
...
Règles :
- date au format ISO (date d'émission ou d'achat)
- amount_ttc = montant total payé TTC (pas HT) ; pour un ticket carburant, prendre le total carte / net à payer
- vendor_name = enseigne émettrice (ex. Total, Shell, Intermarché)
- invoice_number = numéro visible (ex. "655", "F 655", numéro de ticket) ; null si absent
- photo floue ou scan moyen : fais de ton mieux, ne renvoie pas null partout si une info est lisible`;

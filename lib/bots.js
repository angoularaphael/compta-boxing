...
function botTimeoutMs(path) {
  if (path === '/api/status') return 5000;
  if (path === '/api/health') return 5000;
  if (path === '/api/qr') return 5000;
  if (path === '/api/start') return 5000;
  if (path === '/api/stop') return 5000;
  if (path === '/api/logout') return 8000;
  return 10000;
}

...
export function normalizeInvoiceNumber(raw) {
  ...
  // Préserver FAC-2026-003 / DEV-2026-001 (ne pas strip le « F »)
  if (/^(FAC|DEV)-\d{4}-\d{2,}$/i.test(s)) return s.toUpperCase();

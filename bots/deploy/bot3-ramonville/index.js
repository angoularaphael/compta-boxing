 ...
 */
process.env.LOCATION_SLUG = process.env.LOCATION_SLUG || 'ramonville';
process.env.LOCATION_NAME = process.env.LOCATION_NAME || 'Ramonville';
process.env.PORT = process.env.PORT || process.env.SERVER_PORT || '3013';
...
const BOT_PORT = process.env.SERVER_PORT || process.env.PORT || '3013';
...
console.log('=== COMPTA BOXING — BOT 3 : Ramonville ===');

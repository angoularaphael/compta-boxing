 ...
 */
process.env.LOCATION_SLUG = process.env.LOCATION_SLUG || 'st_cyprien';
process.env.LOCATION_NAME = process.env.LOCATION_NAME || 'Saint-Cyprien';
process.env.PORT = process.env.PORT || process.env.SERVER_PORT || '3012';
...
const BOT_PORT = process.env.SERVER_PORT || process.env.PORT || '3012';

const ENV_KEYS = [
  'PORT', 'SERVER_PORT', 'LOCATION_SLUG', 'LOCATION_NAME',
  'COMPTA_WEBHOOK_URL', 'WHATSAPP_WEBHOOK_SECRET', 'ALLOWED_PHONES', 'BOT_ADMIN_PHONE', 'LOG_LEVEL',
];

console.log('=== COMPTA BOXING — BOT 2 : Saint-Cyprien ===');
